...
export default function Homepage() {
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex items-center gap-6">
              <a href="#how-it-works" className="text-gray-600 hover:text-gray-900 transition" data-testid="link-how-it-works">How It Works</a>
              <a href="#pricing" className="text-gray-600 hover:text-gray-900 transition" data-testid="link-pricing">Pricing</a>
              <a href="#features" className="text-gray-600 hover:text-gray-900 transition" data-testid="link-features">Features</a>
              <a href="#faq" className="text-gray-600 hover:text-gray-900 transition" data-testid="link-faq">FAQ</a>
              <Link href="/partner/register">
                <a className="text-gray-600 hover:text-gray-900 transition" data-testid="link-partners">Partners</a>
              </Link>
              <Link href="/client/register">
                <Button className="bg-[#17B6C3] hover:bg-[#1396A1] text-white rounded-full px-6" data-testid="button-header-cta">
                  Start Free Trial
                </Button>
              </Link>
            </nav>
      ...
      <section className="py-16 md:py-24 px-6 border-b border-gray-100">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            ...
            <Link href="/client/register">
              <Button 
                className="bg-[#17B6C3] hover:bg-[#1396A1] text-white text-lg px-8 py-6 rounded-full inline-flex items-center gap-2"
            ...
            <p className="text-sm text-gray-500 mt-3">100% Secure · No credit card required</p>
          </div>
      ...
      <section className="py-16 md:py-24 px-6 border-b border-gray-100">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4 font-heading">Trusted by UK SMEs and finance professionals.</h2>
          ...
          <div className="max-w-3xl mx-auto py-12 border-y border-gray-100">
            <blockquote className="text-center">
              <p className="text-2xl md:text-3xl font-medium text-gray-900 mb-4 italic leading-relaxed">
      ...
      <section className="py-16 md:py-24 px-6 border-b border-gray-100">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4 font-heading">Get Paid Faster, And Bring Your CashFlow to Life</h2>
          </div>

          <div className="space-y-12">
            <div className="flex flex-col md:flex-row items-start gap-8 pb-12 border-b border-gray-100" data-testid="card-benefit-1">
              ...
              <div>
                <h3 className="text-2xl font-bold text-gray-900 mb-4 font-heading">Get Paid Faster</h3>
            ...
            <div className="flex flex-col md:flex-row items-start gap-8 pb-12 border-b border-gray-100" data-testid="card-benefit-2">
              <div className="flex-shrink-0">
                <img 
              ...
              <div>
                <h3 className="text-2xl font-bold text-gray-900 mb-4 font-heading">Stress-Free Chasing</h3>
                <p className="text-gray-600 leading-relaxed mb-4">
            ...
            <div className="flex flex-col md:flex-row items-start gap-8" data-testid="card-benefit-3">
              <div className="flex-shrink-0">
                <img 
              ...
              <div>
                <h3 className="text-2xl font-bold text-gray-900 mb-4 font-heading">See the Future Clearly</h3>
                <p className="text-gray-600 leading-relaxed mb-4">
      ...
      <section id="how-it-works" className="py-16 md:py-24 px-6 border-b border-gray-100">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            <div className="inline-block px-4 py-2 bg-[#A98743]/10 rounded-full mb-4">
              <span className="text-[#A98743] font-semibold text-sm uppercase tracking-wide">KEEPING CASHFLOW SIMPLE</span>
            </div>
            <h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-4 font-heading">How It Works (4 Steps)</h2>
          </div>
          ...
          <div className="space-y-16">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="order-1 lg:order-2">
                ...
                <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4 font-heading">Connect Qashivo to Xero in under 60 seconds</h3>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4 font-heading">Your invoices sync automatically</h3>
                <p className="text-lg text-gray-600 leading-relaxed">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="order-1 lg:order-2">
                ...
                <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4 font-heading">AI begins chasing late payers across email, SMS, and voice</h3>
                <p className="text-lg text-gray-600 leading-relaxed">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4 font-heading">You get paid faster — without lifting a finger</h3>
                <p className="text-lg text-gray-600 leading-relaxed">
      ...
      {/* Features Section */}
      <section id="features" className="py-16 md:py-24 px-6 border-b border-gray-100">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            <div className="inline-block px-4 py-2 bg-[#17B6C3]/10 rounded-full mb-4">
              <span className="text-[#17B6C3] font-semibold text-sm uppercase tracking-wide">CUTTING EDGE TECHNOLOGY</span>
            </div>
            <h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-4 font-heading">Why We Are The #1 Solution</h2>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="text-center p-6" data-testid="card-feature-1">
              <div className="mb-6">
                <img 
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3 font-heading">Multi-Channel Chasing</h3>
              <p className="text-gray-600">Email, SMS, and automated voice reminders</p>
            </div>

            <div className="text-center p-6" data-testid="card-feature-2">
              <div className="mb-6">
                <img 
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3 font-heading">AI CFO Advisor</h3>
              <p className="text-gray-600">Smart insights and debtor scoring at your fingertips</p>
            </div>

            <div className="text-center p-6" data-testid="card-feature-3">
              <div className="mb-6">
                <img 
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3 font-heading">Real-Time Dashboards</h3>
              <p className="text-gray-600">Instantly see overdue invoices and forecast scenarios</p>
            </div>

            <div className="text-center p-6" data-testid="card-feature-4">
              <div className="mb-6">
                <img 
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3 font-heading">Enterprise-Grade Security</h3>
              <p className="text-gray-600">Bank-level encryption and GDPR compliance</p>
            </div>

            <div className="text-center p-6" data-testid="card-feature-5">
              <div className="mb-6">
                <img 
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3 font-heading">Platform Integration</h3>
              <p className="text-gray-600">One-click setup with automatic sync</p>
            </div>

            <div className="text-center p-6" data-testid="card-feature-6">
              <div className="mb-6">
                <img 
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3 font-heading">Cash Flow Forecasting</h3>
      ...
      {/* Pricing Section */}
      <section id="pricing" className="py-16 md:py-24 px-6 border-b border-gray-100">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            <div className="inline-block px-4 py-2 bg-[#A98743]/10 rounded-full mb-4">
              <span className="text-[#A98743] font-semibold text-sm uppercase tracking-wide">SOLUTIONS FOR EVERY BUSINESS</span>
            </div>
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4 font-heading">Check Out Our Pricing</h2>
          </div>

          <div className="grid md:grid-cols-3 gap-8">
            {/* Basic Plan */}
            <div className="bg-white border border-gray-200 rounded-xl p-8" data-testid="card-pricing-basic">
              <h3 className="text-2xl font-bold text-gray-900 mb-2 font-heading">Basic</h3>
              ...
              <Link href="/client/register?plan=standard">
                <Button className="w-full bg-[#17B6C3] hover:bg-[#1396A1] text-white rounded-full" data-testid="button-pricing-basic">
                  30 Day Free Trial
                </Button>
              </Link>
            </div>
            ...
            {/* Premium Plan */}
            <div className="bg-white border-2 border-[#17B6C3] rounded-xl p-8 relative" data-testid="card-pricing-premium">
              <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                <span className="bg-[#17B6C3] text-white px-4 py-1 rounded-full text-sm font-semibold">
                  MOST POPULAR
                </span>
              </div>
              <h3 className="text-2xl font-bold text-gray-900 mb-2 font-heading">Premium</h3>
              ...
              <div className="space-y-3 mb-8">
                ...
                <div className="flex items-start gap-2">
                  <CheckCircle2 className="w-5 h-5 text-[#17B6C3] flex-shrink-0 mt-0.5" />
                  <span className="text-gray-700">Automated Email Chasing</span>
                </div>
                <div className="flex items-start gap-2">
                  <CheckCircle2 className="w-5 h-5 text-[#17B6C3] flex-shrink-0 mt-0.5" />
                  <span className="text-gray-700">Automated SMS Chasing</span>
                </div>
                <div className="flex items-start gap-2">
                  <CheckCircle2 className="w-5 h-5 text-[#17B6C3] flex-shrink-0 mt-0.5" />
                  <span className="text-gray-700">Automated Voice Chasing</span>
                </div>
                <div className="flex items-start gap-2">
                  <CheckCircle2 className="w-5 h-5 text-[#17B6C3] flex-shrink-0 mt-0.5" />
              ...
              <Link href="/client/register?plan=premium">
                <Button className="w-full bg-[#17B6C3] hover:bg-[#1396A1] text-white rounded-full" data-testid="button-pricing-premium">
                  30 Day Free Trial
                </Button>
              </Link>
            </div>
            ...
            {/* Enterprise Plan */}
            <div className="bg-white border border-gray-200 rounded-xl p-8" data-testid="card-pricing-enterprise">
              <h3 className="text-2xl font-bold text-gray-900 mb-2 font-heading">Enterprise</h3>
              ...
              <Link href="/client/register">
                <Button className="w-full bg-[#17B6C3] hover:bg-[#1396A1] text-white rounded-full" data-testid="button-pricing-enterprise">
                  30 Day Free Trial
                </Button>
              </Link>
            </div>
      ...
      {/* FAQ Section */}
      <section id="faq" className="py-16 md:py-24 px-6 border-b border-gray-100">
        <div className="max-w-4xl mx-auto">
          ...
          <Accordion type="single" collapsible className="space-y-4">
            <AccordionItem value="item-1" className="border-b border-gray-100 pb-4">
            ...
            <AccordionItem value="item-2" className="border-b border-gray-100 pb-4">
            ...
            <AccordionItem value="item-3" className="border-b border-gray-100 pb-4">
            ...
            <AccordionItem value="item-4" className="border-b border-gray-100 pb-4">
      ...
      {/* Final CTA Section */}
      <section className="py-16 md:py-24 px-6 bg-[#17B6C3]">
        <div className="max-w-5xl mx-auto text-center">
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-4 font-heading">
            Get Your
          </h2>
          <h3 className="text-5xl md:text-6xl font-bold text-white mb-6 font-heading">
            30 Day Free Trial.
          </h3>
          ...
          <Link href="/client/register">
            <Button
              className="bg-white text-[#17B6C3] hover:bg-gray-100 text-xl px-12 py-7 rounded-full inline-flex items-center gap-2"

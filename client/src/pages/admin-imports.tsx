    ...
    <AdminLayout>
      <div className="sticky top-0 z-40 bg-background border-b border-border">
        <div className="px-6 lg:px-8 py-5">
          ...
          <p className="text-[13px] text-muted-foreground mt-0.5">Data import job history</p>
        </div>
      </div>
      ...
      <div className="p-6 lg:p-8">
        {isLoading ? (
          ...
          <div className="py-16 text-center">
            <FileDown className="w-10 h-10 text-muted-foreground/60 mx-auto mb-4" />
            <p className="text-[15px] font-medium text-foreground mb-1">No import jobs yet</p>
            <p className="text-[13px] text-muted-foreground">Import jobs will appear here when SMEs connect their data</p>
          </div>
        ) : (
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-border">
                  <th className="text-left text-[11px] font-medium text-muted-foreground uppercase tracking-wider py-3 pr-4">SME</th>
                  <th className="text-left text-[11px] font-medium text-muted-foreground uppercase tracking-wider py-3 px-4">Type</th>
                  <th className="text-left text-[11px] font-medium text-muted-foreground uppercase tracking-wider py-3 px-4">Status</th>
                  <th className="text-right text-[11px] font-medium text-muted-foreground uppercase tracking-wider py-3 px-4">Records</th>
                  <th className="text-left text-[11px] font-medium text-muted-foreground uppercase tracking-wider py-3 px-4">Started</th>
                  <th className="text-left text-[11px] font-medium text-muted-foreground uppercase tracking-wider py-3 px-4">Finished</th>
                  <th className="text-right text-[11px] font-medium text-muted-foreground uppercase tracking-wider py-3 pl-4">Actions</th>
                </tr>
              </thead>
              <tbody>
                {jobs.map((job) => (

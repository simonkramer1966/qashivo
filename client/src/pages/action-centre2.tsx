          ...
          <div className="flex items-center gap-2">
            <Popover open={isBulkSkipOpen} onOpenChange={setIsBulkSkipOpen}>
              <PopoverTrigger asChild>
                <button className="px-3 py-1.5 text-[12px] font-medium text-muted-foreground hover:bg-muted rounded-lg transition-colors">
                  Skip
                </button>
              </PopoverTrigger>
            ...
            <div className="px-6">
              ...
              {paginatedActions.map(action => (
                ...
                >
                  ...
                  <div className="w-[20%] px-3 text-[13px] text-muted-foreground truncate">
                    {action.actionType}
                  </div>

        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-start">
            ...
            <div id="dataroom-form" className="relative space-y-2">
              ...
              <div className="rounded-2xl shadow-2xl overflow-hidden bg-white" style={{ minHeight: '655px' }}>
                <iframe
                  src="https://api.leadconnectorhq.com/widget/form/NRFTMQnqftGVqumexWwm"
                  style={{ width: '100%', height: '100%', minHeight: '655px', border: 'none', borderRadius: '3px' }}

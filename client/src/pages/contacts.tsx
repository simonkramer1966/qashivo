          ...
          action={
            <div className="relative w-[280px]">
              ...
              <input
                ...
                className="w-full pl-8 pr-3 h-8 text-[12px] text-muted-foreground placeholder:text-muted-foreground/60 bg-transparent border border-border/60 rounded focus:outline-none focus:border-muted-foreground/60 transition-colors"
            ...
            <div className="sticky bottom-0 flex items-center justify-end gap-4 h-16 px-4 border-t border-border bg-background shrink-0">
              ...
              <div className="flex items-center gap-2">
                <select
                  ...
                  className="text-[12px] text-muted-foreground bg-background border border-border rounded px-2 py-1 focus:outline-none focus:border-muted-foreground/60"

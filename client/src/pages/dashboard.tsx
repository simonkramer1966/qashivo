        ...
        <main className="flex-1 overflow-y-auto main-with-bottom-nav">
          ...
          <div className="container-apple py-4 sm:py-6 lg:py-8">
            <div className="bg-red-500/10 border border-red-500/20 rounded-lg p-6">
              <p className="text-red-600 font-semibold">Failed to load dashboard metrics</p>
              <p className="text-red-500/80 text-sm mt-1">Please try refreshing the page</p>
            </div>
          </div>
        </main>
        <BottomNav />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <Card className="bg-background/80 backdrop-blur-sm border-border/50 shadow-xl p-6" data-testid="card-dso">
            <div className="flex items-start justify-between mb-4">
              ...
              <div className={`p-2 rounded-lg ${metrics.dso.delta30Days < 0 ? 'bg-green-500/10' : 'bg-red-500/10'}`}>
            ...
            <div className="mb-3">
              <div className="flex justify-between items-center text-xs text-muted-foreground/60 mb-1">
          ...
          <Card className="bg-background/80 backdrop-blur-sm border-border/50 shadow-xl p-6" data-testid="card-adaptive-lift">
            ...
            <ResponsiveContainer width="100%" height={280}>
              ...
              >
                ...
                <Bar dataKey="static" fill="currentColor" className="text-muted-foreground/40" radius={[4, 4, 0, 0]} />
              </BarChart>
            </ResponsiveContainer>

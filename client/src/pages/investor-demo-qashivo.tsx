      ...
      <section className="py-24 px-6 bg-gradient-to-br from-blue-50 to-purple-50">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <Card className="p-8 text-center border-2 border-[#0E131F]/30 bg-white" data-testid="card-market-tam">
            ...
            <Card className="p-8 text-center border-2 border-[#8B2635]/30 bg-white" data-testid="card-market-sam">
          ...
          <form onSubmit={handleInvestmentCall} className="space-y-5 pt-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                placeholder="John Smith"
                className={`bg-white ${formErrors.name ? 'border-[#8B2635]' : 'border-gray-300'}`}
                data-testid="input-investor-name"
                required
              />
              {formErrors.name && (
                <p className="text-xs text-[#8B2635] mt-1">{formErrors.name}</p>
              )}
            </div>
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                className={`bg-white ${formErrors.phone ? 'border-[#8B2635]' : 'border-gray-300'}`}
                data-testid="input-investor-phone"
                required
              />
              {formErrors.phone && (
                <p className="text-xs text-[#8B2635] mt-1">{formErrors.phone}</p>
              )}
            </div>
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                className={`bg-white ${formErrors.email ? 'border-[#8B2635]' : 'border-gray-300'}`}
                data-testid="input-investor-email"
                required
              />
              {formErrors.email && (
                <p className="text-xs text-[#8B2635] mt-1">{formErrors.email}</p>
              )}
            </div>
            ...
            <div className="border-t border-gray-200 pt-4 space-y-4">
              ...
              <div>
                ...
                {formErrors.highNetWorth && (
                  <p className="text-xs text-[#8B2635] mt-2 ml-7">{formErrors.highNetWorth}</p>
                )}
              </div>
              ...
              <div>
                ...
                {formErrors.risk && (
                  <p className="text-xs text-[#8B2635] mt-2 ml-7">{formErrors.risk}</p>
                )}
              </div>
            </div>

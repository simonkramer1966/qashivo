        ...
        <div className="flex-1 flex flex-col min-h-0 overflow-y-auto">
          <div className="container-apple py-4 sm:py-6 flex-1 flex flex-col min-h-0">
            ...
            <section className="flex-1 flex flex-col min-h-0 mb-6">
              <div className="flex items-center justify-between mb-3 flex-shrink-0">
                <div>
                  ...
                  <p className="text-[11px] text-muted-foreground mt-0.5">Net cash over time, with confidence intervals. Updates automatically.</p>
                </div>
              ...
              <div className="flex-1 min-h-[200px] relative">
                <p className="absolute top-2 right-4 text-[10px] text-muted-foreground z-10">
              ...
              <div className="h-[80px] flex-shrink-0 relative">
                <div className="flex items-center justify-between mb-1 px-1">
                  <p className="text-[10px] text-muted-foreground">Weekly cash in/out</p>
            ...
            <section className="flex-shrink-0 pb-4">
              <p className="text-[10px] text-muted-foreground uppercase tracking-wider mb-4">Forecast Quality & Cashflow Health</p>
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 sm:gap-8">
                <div>
                  ...
                  <p className="text-[20px] font-semibold text-foreground tabular-nums">
                    High <span className="text-[14px] font-normal text-muted-foreground">· 92%</span>
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-[20px] font-semibold text-foreground tabular-nums">
                    4.6 <span className="text-[12px] font-normal text-muted-foreground">months</span>
                  </p>
                </div>

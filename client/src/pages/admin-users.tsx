      ...
      <div className="p-6 lg:p-8">
        {isLoading ? (
          ...
          <div className="py-16 text-center">
            ...
            <p className="text-[13px] text-muted-foreground/60 mb-6">Invite your first user to get started</p>
          </div>
        ) : (
      ...
      <Dialog open={isInviteOpen} onOpenChange={setIsInviteOpen}>
        <DialogContent className="sm:max-w-md">
          ...
          <div className="space-y-4 py-4">
            ...
            {showPartnerSelect && (
              <div>
                <Label className="text-[13px] font-medium text-foreground">Partner *</Label>
                <Select
            ...
            {showSmeSelect && (
              <div>
                <Label className="text-[13px] font-medium text-foreground">SME *</Label>
                <Select

      ...
      <main className="flex-1 overflow-y-auto">
        ...
        <div className="p-8 space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <Card className="bg-white/70 backdrop-blur-md border-0 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105" data-testid="card-net-cashflow">
            ...
            <Card className="bg-white/70 backdrop-blur-md border-0 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105" data-testid="card-money-in">
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <Card className="bg-white/70 backdrop-blur-md border-0 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105" data-testid="card-money-out">
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <Card className="bg-white/70 backdrop-blur-md border-0 shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105" data-testid="card-cash-runway">
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2">
              <Card className="bg-white/80 backdrop-blur-sm border-white/50 shadow-lg" data-testid="card-cashflow-chart">
                <CardHeader>
            ...
            <div className="space-y-6">
              <Card className="bg-white/80 backdrop-blur-sm border-white/50 shadow-lg" data-testid="card-quick-insights">
                <CardHeader>
              ...
              <Card className="bg-white/80 backdrop-blur-sm border-white/50 shadow-lg" data-testid="card-cash-position">
                <CardHeader>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <Card className="bg-white/80 backdrop-blur-sm border-white/50 shadow-lg" data-testid="card-30day-forecast">
              <CardHeader>
                <div className="flex items-center justify-between">
                  <div>
            ...
            <Card className="bg-white/80 backdrop-blur-sm border-white/50 shadow-lg" data-testid="card-payment-schedule">
              <CardHeader>
                <div className="flex items-center justify-between">
                  <div>

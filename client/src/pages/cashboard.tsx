      ...
      <main className="flex-1 flex flex-col min-h-0 main-with-bottom-nav">
        ...
        <div className="flex-1 flex flex-col min-h-0 overflow-y-auto">
          ...
          <section className="hidden sm:block mb-6 flex-shrink-0">
            <p className="text-[10px] text-muted-foreground/60 uppercase tracking-wider mb-4">State of Cash</p>
            <div className="grid grid-cols-4 gap-8">
              ...
              <div data-testid="card-total-outstanding">
                ...
                {metricsLoading ? (
                  ...
                  <p className="text-[20px] font-semibold text-foreground tabular-nums">
                    {formatCurrency(totalOutstanding)} <span className="text-[12px] font-normal text-muted-foreground/60">({totalInvoiceCount})</span>
                  </p>
                )}
              </div>
              ...
              <div data-testid="card-overdue">
                ...
                {metricsLoading ? (
                  ...
                  <p className="text-[20px] font-semibold text-foreground tabular-nums">
                    {formatCurrency(overdueAmount)} <span className="text-[12px] font-normal text-muted-foreground/60">({overdueCount})</span>
                  </p>
                )}
              </div>
          ...
          <section className="sm:hidden mb-6 flex-shrink-0">
            <p className="text-[10px] text-muted-foreground/60 uppercase tracking-wider mb-3">State of Cash</p>
          ...
          {/* Hairline divider */}
          <div className="border-t border-border mb-6 flex-shrink-0" />
                  ...
                  <ComposedChart data={formatChartData()}>
                    ...
                    <RechartsTooltip
                      content={({ active, payload, label }) => {
                        ...
                        if (!data) return null;
                        return (
                          <div className="bg-background border border-border rounded-md p-3 shadow-sm text-[12px]">
          ...
          <section className="flex-shrink-0 pb-4">
            <p className="text-[10px] text-muted-foreground/60 uppercase tracking-wider mb-4">Behaviour Performance</p>
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 sm:gap-8">
              ...
              <div data-testid="card-perf-avg-days-late">
                ...
                {metricsLoading ? (
                  ...
                  <p className="text-[20px] font-semibold text-foreground tabular-nums">
                    {Math.abs(avgDaysOverdue).toFixed(0)} <span className="text-[12px] font-normal text-muted-foreground/60">days</span>
                  </p>
                )}
              </div>
              ...
              <div data-testid="card-perf-avg-days-pay">
                ...
                {metricsLoading ? (
                  ...
                  <p className="text-[20px] font-semibold text-foreground tabular-nums">
                    45 <span className="text-[12px] font-normal text-muted-foreground/60">days</span>
                  </p>
                )}
              </div>

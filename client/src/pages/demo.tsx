  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        {mobileMenuOpen && (
          <div className="md:hidden border-t border-[#E6E8EC] bg-white px-6 py-4">
            <div className="flex flex-col gap-4">
              ...
              <a href="/demo" className="text-[16px] text-[#0B0F17] font-medium py-2">Demo</a>
      ...
      <section className="py-10 md:py-16">
        <div className="max-w-[1200px] mx-auto px-6">
          <div className="max-w-[700px] mx-auto text-center mb-12">
            <h2 className="text-[40px] md:text-[48px] font-semibold text-[#0B0F17] leading-[1.1] tracking-[-0.02em] mb-6">Two-way communciation with Email</h2>
            <p className="text-[18px] md:text-[20px] text-[#556070] leading-[1.55]">

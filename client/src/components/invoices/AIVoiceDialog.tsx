...
const voiceScripts: Record<VoiceScript, { 
  ...
  soft: {
    ...
    opening: "Hello, may I speak with {customerName} please? ... Great, thank you. This is an automated call from {organisationName}. Please note this call is being recorded for training and quality purposes. Is now a good time to speak briefly about your account?",

          ...
          <div className="p-6">
            ...
            <Collapsible open={contactInfoOpen} onOpenChange={setContactInfoOpen} className="mb-4">
              <CollapsibleTrigger className="w-full">
                <div className={`flex items-center justify-between p-4 bg-muted hover:bg-muted transition-colors ${contactInfoOpen ? 'rounded-t-lg' : 'rounded-lg'}`}>
                  <h3 className="font-semibold text-foreground">Contact & Client Info</h3>
                  <ChevronDown className={`h-5 w-5 transition-transform ${contactInfoOpen ? 'rotate-180' : ''}`} />
                </div>
              </CollapsibleTrigger>
              <CollapsibleContent>
                <div className="p-4 border border-border rounded-b-lg space-y-3">
                  ...
                  {safeInvoice.contact?.address && (
                    <div className="flex items-start gap-3">
                      ...
                      <p className="text-sm text-muted-foreground">{safeInvoice.contact.address}</p>
                    </div>
                  )}
            ...
            <Collapsible open={automationOpen} onOpenChange={setAutomationOpen} className="mb-4">
              <CollapsibleTrigger className="w-full">
                <div className={`flex items-center justify-between p-4 bg-muted hover:bg-muted transition-colors ${automationOpen ? 'rounded-t-lg' : 'rounded-lg'}`}>
                  <h3 className="font-semibold text-foreground">Automation & Schedule Status</h3>
                ...
                <div className="p-4 border border-border rounded-b-lg">
                  ...
                  <div className="space-y-3 mb-4">
                    ...
                    <div className="flex gap-3">
                      ...
                      <div className="flex-1 pb-3">
                        <div className="flex items-center justify-between">
                          ...
                          <p className="text-xs text-muted-foreground">25 Sept @ 8:00 AM</p>
                        </div>
                    ...
                    <div className="flex gap-3">
                      ...
                      <div className="flex-1 pb-3">
                        <div className="flex items-center justify-between">
                          ...
                          <p className="text-xs text-muted-foreground">2 Oct @ 2:30 PM</p>
                        </div>
                        <p className="text-xs text-emerald-600 mt-1">✓ Completed</p>
                      </div>
                    </div>
                    ...
                    <div className="flex gap-3">
                      ...
                      <div className="flex-1 pb-3">
                        <div className="flex items-center justify-between">
                          <p className="text-sm font-medium text-foreground">AI Voice Call</p>
                    ...
                    <div className="flex gap-3">
                      ...
                      <div className="flex-1 pb-3">
                        <div className="flex items-center justify-between">
                          <p className="text-sm font-medium text-muted-foreground">Follow-up Email</p>
                          <p className="text-xs text-muted-foreground">9 Oct @ 9:00 AM</p>
                        </div>
                    ...
                    <div className="flex gap-3">
                      ...
                      <div className="flex-1">
                        <div className="flex items-center justify-between">
                          <p className="text-sm font-medium text-muted-foreground">Final Notice SMS</p>
                          <p className="text-xs text-muted-foreground">12 Oct @ 10:00 AM</p>
                        </div>
                        <p className="text-xs text-muted-foreground mt-1">📅 Scheduled</p>
                      </div>
                    </div>
            ...
            {invoice.status !== 'paid' && (
              <div className="mb-4 p-4 bg-gradient-to-br from-blue-50 to-teal-50 rounded-lg border border-blue-200">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <h3 className="font-semibold text-foreground">Invoice Insurance Options</h3>
                </div>
                
                <div className="space-y-2 mb-4">
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-muted-foreground">Free Cover Available:</span>
                    <span className="font-semibold">{formatCurrency(freeCover)} (50%)</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-muted-foreground">Upgrade to Full Cover:</span>
                    <span className="font-semibold text-[#17B6C3]">+£{fullCoverCost.toFixed(2)}</span>
                  </div>
                  <p className="text-xs text-muted-foreground">Provider: Qashivo Insurance Partners</p>
                </div>
            ...
            {invoice.status !== 'paid' && outstanding >= 1000 && (
              <div className="mb-4 p-4 bg-gradient-to-br from-emerald-50 to-teal-50 rounded-lg border border-emerald-200">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <h3 className="font-semibold text-foreground">Finance Available</h3>
                </div>
                
                <div className="space-y-2 mb-4">
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-muted-foreground">Advance Available:</span>
                    <span className="font-semibold">{formatCurrency(advanceAvailable)} (80%)</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-muted-foreground">Fee (2.5% per 30 days):</span>
                    <span className="font-semibold">{formatCurrency(financeFee)}</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-muted-foreground">Repayment Term:</span>
                    <span className="font-semibold">60 days</span>
                  </div>
                  <div className="flex justify-between items-center pt-2 border-t border-emerald-200">
                    <span className="text-sm font-medium text-foreground">Repayment Due:</span>
                ...
                <p className="text-xs text-muted-foreground mt-2 text-center">Funds released to Qashivo Wallet instantly</p>
              </div>
            )}

            {/* Activity Feed */}
            <div className="mb-4">
              <h3 className="font-semibold text-foreground mb-3">Activity & Communications</h3>
              <div className="space-y-3 p-4 bg-muted rounded-lg">
                ...
                <div className="flex gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-muted-foreground">2 Oct at 10:00 AM</p>
                  </div>
                </div>
                <Separator />
                <div className="flex gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-muted-foreground">25 Sept at 8:00 AM</p>
                  </div>
                </div>
              </div>
            </div>

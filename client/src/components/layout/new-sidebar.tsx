                ...
                <>
                  ...
                  <div className="max-h-64 overflow-y-auto">
                    {organizationsToShow.length > 0 ? (
                        ...
                        return (
                          ...
                          >
                            <div className="flex items-center space-x-3 w-full">
                              ...
                              <span className={cn("flex-1 text-sm truncate", isCurrentOrg ? "text-[#17B6C3]" : "text-foreground")}>{companyName}</span>
                              {isCurrentOrg && (
                      ...
                      <div className="px-3 py-3 text-sm text-muted-foreground/60 text-center">
        ...
        {!isCollapsed && (
          <div className="mt-auto p-3 space-y-2">
            ...
            <SimpleDropdown
              ...
              trigger={
                <button className="w-full flex items-center space-x-2.5 hover:bg-muted rounded-lg px-2 py-2 transition-colors" data-testid="button-user-menu">
                  <SimpleAvatar
                    className="h-7 w-7"
                  ...
                  <div className="flex-1 text-left min-w-0">
                    <p className="text-[13px] text-foreground truncate" data-testid="text-user-name">
                      {(() => {
                        const firstName = (user as any)?.firstName;
                        const lastName = (user as any)?.lastName;
        ...
        {isCollapsed && (
          <div className="mt-auto p-2 space-y-1">
            <SimpleDropdown
              ...
              className="w-48 border-border"
              trigger={
                <button className="w-full flex items-center justify-center hover:bg-muted rounded-lg p-2 transition-colors" data-testid="button-user-menu-collapsed">
                  <SimpleAvatar
                    className="h-7 w-7"

...
export default function AddCustomerDialog({
  ...
  const renderStep1 = () => (
    <div className="space-y-6">
      <div>
        <h3 className="text-2xl font-bold text-foreground mb-2">Who are we trading with?</h3>
  ...
  const renderStep2 = () => (
    <div className="space-y-6">
      <div>
        <h3 className="text-2xl font-bold text-foreground mb-2">Trading Profile</h3>
        <p className="text-sm text-muted-foreground">
      ...
      <div className="space-y-4">
        <div>
          <div className="flex items-center justify-between mb-2">
            <label className="text-sm font-medium text-foreground">Estimated Monthly Sales</label>
        ...
        <div>
          <label className="block text-sm font-medium text-foreground mb-2">Average Invoice Value</label>
          <Input
            type="number"
            placeholder="0"
        ...
        <div>
          <label className="block text-sm font-medium text-foreground mb-2">Expected Max Outstanding</label>
          <Input
            type="number"
            placeholder="0"
        ...
        <div>
          <label className="block text-sm font-medium text-foreground mb-2">Payment Method Preference</label>
          <Select
        ...
        <div>
          <label className="block text-sm font-medium text-foreground mb-2">Disputes Email</label>
          <Input
            type="email"
  ...
  const renderStep3 = () => {
    ...
    return (
      <div className="space-y-6">
        <div>
          <h3 className="text-2xl font-bold text-foreground mb-2">Credit Signals</h3>
          <p className="text-sm text-muted-foreground">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                <Tooltip>
                  <TooltipTrigger asChild>
                    <div className="bg-background/80 backdrop-blur-sm border border-white/50 shadow-lg p-4 rounded-lg">
                      <div className="flex items-start justify-between">
                        <div className="flex items-center gap-2">
                          <Calendar className="h-4 w-4 text-[#17B6C3]" />
                          <span className="text-sm font-medium text-foreground">Company Age</span>
                        </div>
                      ...
                      <p className="text-xs text-muted-foreground mt-1">{signals.companyAgeMonths} months</p>
                    </div>
                  </TooltipTrigger>
                  <TooltipContent>
                    ...
                    <div className="bg-background/80 backdrop-blur-sm border border-white/50 shadow-lg p-4 rounded-lg">
                      <div className="flex items-start justify-between">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-sm font-medium text-foreground">Filings On Time</span>
                        </div>
                    ...
                    <div className="bg-background/80 backdrop-blur-sm border border-white/50 shadow-lg p-4 rounded-lg">
                      <div className="flex items-start justify-between">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-sm font-medium text-foreground">CCJs / Legal Flags</span>
                        </div>
                        {getSignalStatusChip(
                          signals.adverseCount === 0 ? "good" : signals.adverseCount === 1 ? "caution" : "risk"
                        )}
                      </div>
                      <p className="text-2xl font-bold text-foreground mt-2">{signals.adverseCount}</p>
                    </div>
                  </TooltipTrigger>
                  <TooltipContent>
                    ...
                    <div className="bg-background/80 backdrop-blur-sm border border-white/50 shadow-lg p-4 rounded-lg">
                      <div className="flex items-start justify-between">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-sm font-medium text-foreground">Director Changes (12m)</span>
                        </div>
                        {getSignalStatusChip(signals.directorChanges12m <= 1 ? "good" : "risk")}
                      </div>
                      <p className="text-2xl font-bold text-foreground mt-2">{signals.directorChanges12m}</p>
                    </div>
                  </TooltipTrigger>
                  <TooltipContent>
                    ...
                    <div className="bg-background/80 backdrop-blur-sm border border-white/50 shadow-lg p-4 rounded-lg">
                      <div className="flex items-start justify-between">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-sm font-medium text-foreground">Sector Risk</span>
                        </div>
                        {getSignalStatusChip(
                          signals.sectorRisk === "low" ? "good" : signals.sectorRisk === "medium" ? "caution" : "risk"
                        )}
                      </div>
                      <p className="text-2xl font-bold text-foreground mt-2 capitalize">{signals.sectorRisk}</p>
                    </div>
                  </TooltipTrigger>
                  <TooltipContent>
                    ...
                    <div className="bg-background/80 backdrop-blur-sm border border-white/50 shadow-lg p-4 rounded-lg">
                      <div className="flex items-start justify-between">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-sm font-medium text-foreground">Bureau Score</span>
                        </div>
                        {getSignalStatusChip(
                          signals.bureauScore >= 70 ? "good" : signals.bureauScore >= 40 ? "caution" : "risk"
                        )}
                      </div>
                      <p className="text-2xl font-bold text-foreground mt-2">{signals.bureauScore}/100</p>
                      <div className="mt-2">
                    ...
                    <div className="bg-background/80 backdrop-blur-sm border border-white/50 shadow-lg p-4 rounded-lg">
                      <div className="flex items-start justify-between">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-sm font-medium text-foreground">Payment Behavior (DBT)</span>
                        </div>
                        {getSignalStatusChip(
                          signals.dbtDays <= 0 ? "good" : signals.dbtDays <= 10 ? "caution" : "risk"
                        )}
                      </div>
                      <p className="text-2xl font-bold text-foreground mt-2">{signals.dbtDays} days</p>
                    </div>
                  </TooltipTrigger>
                  <TooltipContent>
  ...
  const renderStep4 = () => {
    ...
    return (
      <div className="space-y-6">
        <div>
          <h3 className="text-2xl font-bold text-foreground mb-2">Risk & Recommendation</h3>
          <p className="text-sm text-muted-foreground">Review automated credit assessment</p>
        </div>

        <div className="bg-background/80 backdrop-blur-sm border border-white/50 shadow-lg p-6 rounded-lg">
          <div className="flex items-start justify-between mb-6">
            <div>
              <p className="text-sm text-muted-foreground mb-2">Qashivo Risk Score</p>
              <p className="text-5xl font-bold text-foreground">{recommendation.score.value}</p>
            </div>
          ...
          <div className="border-t pt-4 space-y-3">
            <div className="flex justify-between">
              <span className="text-sm text-muted-foreground">Recommended Credit Limit</span>
              <span className="text-lg font-bold text-foreground">
                {formatCurrency(recommendation.creditLimit)}
              </span>
            </div>
            <div className="flex justify-between">
              <span className="text-sm text-muted-foreground">Recommended Payment Terms</span>
              <span className="text-lg font-bold text-foreground">{recommendation.paymentTerms}</span>
            </div>
          </div>
  ...
  const renderStep5 = () => {
    ...
    return (
      <div className="space-y-6">
        <div>
          <h3 className="text-2xl font-bold text-foreground mb-2">Policy Checks</h3>
          <p className="text-sm text-muted-foreground">Validating against your credit policy</p>
        </div>
        ...
        <div className="bg-background/80 backdrop-blur-sm border border-white/50 shadow-lg p-6 rounded-lg">
          {passed ? (
            <div className="text-center py-8">
              ...
              <h4 className="text-xl font-bold text-foreground mb-2">Policy checks passed ✅</h4>
              <p className="text-sm text-muted-foreground">All requirements met, ready to approve</p>
            </div>
          ) : (
            <div className="space-y-4">
  ...
  const renderStep6 = () => {
    ...
    if (approvalSuccess) {
      return (
        <div className="text-center py-12">
          ...
          <h4 className="text-2xl font-bold text-foreground mb-2">Customer approved and synced to Xero ✅</h4>
          <p className="text-sm text-muted-foreground mb-6">Credit terms have been applied</p>
    ...
    return (
      <div className="space-y-6">
        <div>
          <h3 className="text-2xl font-bold text-foreground mb-2">Decision & Sync</h3>
          <p className="text-sm text-muted-foreground">Review and approve customer setup</p>
        </div>
        ...
        <div className="bg-background/80 backdrop-blur-sm border border-white/50 shadow-lg p-6 rounded-lg">
          ...
          <div className="space-y-3 mb-6">
            <div className="flex justify-between items-center">
              ...
              <span className="font-medium text-foreground">{state.businessData.legalName}</span>
            </div>
            <div className="flex justify-between items-center">
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      >
        <DialogHeader className="p-4 sm:p-6 border-b bg-background/50 backdrop-blur-sm flex-shrink-0">
        ...
        <div className="sticky bottom-0 p-4 sm:p-6 border-t bg-background/80 backdrop-blur-sm flex-shrink-0">

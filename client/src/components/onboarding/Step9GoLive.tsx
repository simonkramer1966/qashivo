...
export default function Step9GoLive({ status, onBack }: Props) {
  ...
  const userName = status?.companyDetails?.subscriberFirstName || "there";
  ...
  return (
    <div>
      ...
      {/* Riley summary */}
      <div className="border border-[#14b8a6]/20 rounded-lg p-5 mb-6 bg-[#14b8a6]/5">
        <div className="flex items-start gap-3">
          <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-[#14b8a6]/10 text-sm font-semibold text-[#14b8a6]">
            R
          </div>

...
// SSE streaming helper imported from @/lib/rileyStreaming
...
export default function FloatingRileyChat() {
  ...
  // Don't render on onboarding page, public pages, or partner portal (has its own Portfolio Riley)
  if (location === "/onboarding" || location.startsWith("/investors") || location.startsWith("/debtor-portal") || location.startsWith("/partner")) return null;

...
export const tenants = pgTable("tenants", {
  ...
  minimumChaseThreshold: decimal("minimum_chase_threshold", { precision: 10, scale: 2 }).default('50.00'), // Gap 4: Skip chasing if consolidated total below this amount (GBP) — DEPRECATED, superseded by smallAmountThreshold
  smallAmountThreshold: decimal("small_amount_threshold", { precision: 10, scale: 2 }).default('50.00'), // Below this amount, invoices are classified as "small balance" for softer chasing
  smallAmountChaseEnabled: boolean("small_amount_chase_enabled").default(true), // When false, small-balance debtors are skipped entirely; when true, chased with softer tone
...
export const partnerBillingConfig = pgTable("partner_billing_config", {
  ...
  volumeDiscountPercent: decimal("volume_discount_percent", { precision: 5, scale: 2 }).default("0"),
  volumeDiscountTier: varchar("volume_discount_tier").default("none"),
  qapitalRevSharePercent: decimal("qapital_rev_share_percent", { precision: 5, scale: 2 }).default("10.00"),
  qapitalFacilitationFeePercent: decimal("qapital_facilitation_fee_percent", { precision: 5, scale: 2 }).default("0.50"),
  isActive: boolean("is_active").default(true),
  createdAt: timestamp("created_at").defaultNow(),
  updatedAt: timestamp("updated_at").defaultNow(),
});
